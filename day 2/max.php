...
<body>
    <div class="col-3 x-auto m-auto mt-5 text-center">
        ...
        <form method="post" class="form-control col-4 px-2">
            <input type="number" name='first_number' class="form-control mx-auto my-2" placeholder="first number">
            <input type="number" name='second_number' class="form-control mx-auto my-2" placeholder="second number">
            <input type="number" name='third_number' class="form-control mx-auto my-2" placeholder="third number">
